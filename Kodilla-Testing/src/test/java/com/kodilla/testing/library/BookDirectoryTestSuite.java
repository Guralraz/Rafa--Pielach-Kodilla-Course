...
public class BookDirectoryTestSuite {
    ...
    void testListBooksInHandsOf() {
        //Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser1 = new LibraryUser("Ralph", "Lauren", "42069");
        LibraryUser libraryUser2 = new LibraryUser("Mark", "Dowson", "69420");
        LibraryUser libraryUser3 = new LibraryUser("Lucius", "Clay", "88666");
        ...
        List<Book> theListOfBooks2 = bookLibrary.listBooksInHandsOf(libraryUser2);
        List<Book> theListOfBooks3 = bookLibrary.listBooksInHandsOf(libraryUser3);

        //Then
        assertEquals(0, theListOfBooks1.size());
        assertEquals(1, theListOfBooks2.size());
        assertEquals(5, theListOfBooks3.size());
    }
